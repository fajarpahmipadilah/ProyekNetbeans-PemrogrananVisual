  ...
  PreparedStatement st = null;
    ...
    public List<Model_DetPemesanan> getData(String id) {
       PreparedStatement st = null;
        ...
        ResultSet rs = null;
        String sql = "SELECT det_psn.no_pesan, det_psn.kode_barang,brg.nama_barang,brg.harga,det_psn.jml_pesan,det_psn.subtotal_pesan,det_psn.status FROM detail_pemesanan det_psn INNER JOIN pemesanan psn ON psn.no_pesan=det_psn.no_pesan INNER JOIN barang brg ON brg.kode_barang=det_psn.kode_barang WHERE det_psn.no_pesan='"+id+"'ORDER BY no_pesan ASC";
