...
import tablemodel.TableMod_Suplier;

/**
 *
 * @author Kulub Cau
 */
public class Data_Suplier extends javax.swing.JDialog {
        int xx,xy;
     private Service_Suplier servis = new DAO_Suplier();
     private TableMod_Suplier tblModel= new TableMod_Suplier();
     public Model_Suplier model = new Model_Suplier();
    /**
     * Creates new form Data_JenisBarang
     */
    public Data_Suplier(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Data_Suplier dialog = new Data_Suplier(new javax.swing.JFrame(), true);
    ...
    private void pencarian(){
        List<Model_Suplier> list = servis.pencarian(t_search.getText());
        tblModel.setData(list);
    }
    
    
    private void loadData(){
        List<Model_Suplier> list = servis.getData();
        tblModel.setData(list);
    }
    private void pilihData(){
        int row = tbl_data.getSelectedRow();
        
        model.setId_suplier(tbl_data.getModel().getValueAt(row, 0).toString());
        model.setNama_suplier(tbl_data.getModel().getValueAt(row, 1).toString());
        dispose();
    }
