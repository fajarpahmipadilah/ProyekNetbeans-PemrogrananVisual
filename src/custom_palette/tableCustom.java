 ...
 * @author proxc
 */
public class tableCustom extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tableCustom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
